const texts = {
    EN: {
        ...
        projects: "Projects",
        contact: "Contact",
        contactinfo: "Send an email to codelur@gmail.com: ",
        contactsocials: " or to the following development sites: ",
        english: "English",
        spanish: "Spanish",
        language: "Language",
        myinfo: "Experienced Software Developer specializing in Object-Oriented Programming, "+
                "Data Structures, Algorithms, Collections, Stream API, exception handling, and JUnit in Java. <br/>"+
    ...
    ES: {
        ...
        projects: "Proyectos",
        contact: "Contactar",
        contactinfo: "Envia un email a codelur@gmail.com: ",
        contactsocials: "o en uno de mis perfiles: ",
        english: "Ingles",
        spanish: "Español",
        language: "Idioma",
        myinfo: "Desarrollador de software experimentado especializado en programación orientada a objetos, "+
                "estructuras de datos, algoritmos, colecciones, API de flujo, manejo de excepciones y JUnit en Java. <br/>"+
